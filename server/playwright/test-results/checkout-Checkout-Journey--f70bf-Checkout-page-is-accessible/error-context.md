...
- Name: checkout.spec.ts >> Checkout Journey Validation >> Step 5: Checkout page is accessible
- Location: tests\checkout.spec.ts:103:3
...
```yaml
- generic [active] [ref=f2e1]: Nothing Found
```
